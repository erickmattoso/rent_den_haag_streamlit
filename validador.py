...
def page_settings():
    ...
    # row1.number_input(f'Members of your household:',step=1)
    # row2.number_input(f'Eating lunch or dinner in restaurants: X% of the time',step=1)
    # row1.number_input(f'When eating in restaurants you are chosing inexpensive restaurants: X% of the time',step=1)
    # row2.number_input(f'Drinking Coffee outside of your home: Moderate',step=1)
    # row1.number_input(f'Going out (cinema, night life, etc.): average (once per week per household member)',step=1)
    # row2.number_input(f'Smoking (household overall): 0.0 packs of cigarettes per day',step=1)
    # row1.number_input(f'Alcoholic beverages (consume): Moderate',step=1)
    # row2.number_input(f'At home we are eating: Western food',step=1)
    # row1.number_input(f'Driving car: No',step=1)
    # row2.number_input(f'Taking Taxi: No',step=1)
    # row1.number_input(f'Paying for public transport tickets: Monthly, All Members',step=1)
    # row2.number_input(f'Sport Memberships: All Household Members',step=1)
    # row1.number_input(f'Vacation and Travel: None',step=1)
    # row2.number_input(f'Buying Clothing and Shoes: Moderate',step=1)
    # row1.number_input(f'Rent: none',step=1)
    # row2.number_input(f'Number of your children going to the kindergarten: 0',step=1)
    # # row1.number_input(f'Number of your children going to the private school: 0',step=1)
    ##########################################
